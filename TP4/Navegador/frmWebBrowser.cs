    ...
    public partial class frmWebBrowser : Form
    {
        ...
        private void btnIr_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                Uri miDireccion = new Uri(this.txtUrl.Text);

                Descargador descargador = new Descargador(miDireccion);

                descargador.DescProgreso += new Descargador.DescargaEnProceso(this.ProgresoDescarga);
                descargador.DescFinalizada += new Descargador.DescargaFinalizada(this.FinDescarga);
            ...
            {
                MessageBox.Show(ex.Message, "Problema al cargar la pagina.");
